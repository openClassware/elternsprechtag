...
| Fall | Akteur | Erwartet | Stufe | Heute |
|---|---|---|---|---|
| Einzelne Lehrkraft fällt aus (ganz oder teilweise) | Eltern | Termine entfallen, betroffene Familien werden benachrichtigt | muss | **erfüllt** — der Use Case `EntfallenLassen` setzt `ENTFAELLT` je Termin, storniert die Buchung mit (#157) und benachrichtigt nach Commit jede betroffene Adresse mit *einer* Mail (#158); ausgelöst wird er am Lehrkraft-Abschnitt der Auswertung über die Sammelaktion „Lehrkraft fällt aus" (#159) |
