...
| `demo`     | [`application-demo.properties`](../src/main/resources/application-demo.properties) | Öffentliche Vorführinstanz: Demo-Daten aus `db/demo/R__demo_stammdaten.sql`, kein Browser-Autostart.                                                                       |
