 ...
 * Text formuliert die aufrufende Kernlogik — dieser Sender kennt den Anlass nicht.
 *
 * <p>In Produktion die aktive Implementierung, sobald SMTP konfiguriert ist ({@code
 * spring.mail.host}); ohne Konfiguration greift die {@link LoggingBenachrichtigungSender
 * Log-Attrappe} — siehe {@link BenachrichtigungConfig}.
 *
